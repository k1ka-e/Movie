...
@section('title', 'Редактирование карьеры')
@section('content')
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 d-flex justify-content-end">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Редактирование карьеры</li>
                        </ol>
                    </div><!-- /.col -->
                </div>
                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('admin.career.update', $career->id) }}" method="POST" class="pt-3
                        w-25">
                        @csrf
                        @method('PATCH')
